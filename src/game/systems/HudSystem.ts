...
export class HudSystem implements System {
    ...
    public showWaitingForDrivers(driversRemaining: number) {
        ...
        this._waitingMessage.y = designConfig.content.height / 2 - 50;
    ...
    public showDynamicResults(finishOrder: Array<{racerId: string, driverName: string, position: number, finishTime: number}>) {
    ...
    public updateDynamicResults(finishOrder: Array<{racerId: string, driverName: string, position: number, finishTime: number}>) {
